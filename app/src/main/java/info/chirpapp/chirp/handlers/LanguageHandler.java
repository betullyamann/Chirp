...
public class LanguageHandler {
    ...
    private static final ArrayList<String> STOP_WORDS = new ArrayList<>(Arrays.asList("a", "acaba", "altı", "altmış", "ama", "ancak", "anlam",
            ...
            "edecek", "eden", "ederek", "edilecek", "ediliyor", "edilmesi", "ediyor", "eğer", "elbette", "elli", "en", "etmesi", "et", "etti",
            ...
            "hiç", "hiçbir", "hiçbiri", "i", "ı", "için", "içinde", "iki", "ile", "ilgili", "ise", "isim", "işte", "itibaren", "itibariyle",
            "kaç", "kadar", "karşın", "kendi", "kendilerine", "kendine", "kendini", "kendisi", "kendisine", "kendisini", "kez", "ki",
            "kim", "kime", "kimi", "kimin", "kimisi", "kimse", "kırk", "madem", "mesela", "madde", "mi", "mı", "milyar", "milyon", "mu", "mü", "nasıl",
            "ne", "neden", "nedenle", "nerde", "nerede", "nereye", "neyse", "niçin", "nin", "nın", "niye", "nun", "nün", "o", "of", "öbür",
            "olan", "olarak", "oldu", "olduğu", "olduğunu", "olduklarını", "olmadı", "olmadığı", "olmak", "olması", "olmayan", "olmaz",
            "olsa", "olsun", "olup", "olur", "olur", "olursa", "oluyor", "on", "ol", "ön", "ona", "önce", "ondan", "onlar", "onlara", "onlardan",
